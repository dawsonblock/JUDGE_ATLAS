"""Add valid_from/valid_to/is_active/superseded_by_section_key to legal_sections and valid_from/change_type to legal_section_revisions.
...
def upgrade() -> None:
    # legal_sections — section history / point-in-time columns
    op.add_column(
        "legal_sections",
    ...
    op.add_column(
        "legal_sections",
        sa.Column("superseded_by_section_key", sa.String(80), nullable=True),
    )

    # legal_section_revisions — revision metadata
    op.add_column(
